...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/ao-Barbosa/phi/issues/123))`
- External: `Added bar ([#456](https://github.com/ao-Barbosa/phi/pull/456) by [@user](https://github.com/user))`
