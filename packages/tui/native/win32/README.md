...
For non-Windows cross-builds, or for custom Windows toolchains, set `PHI_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
PHI_TUI_WIN32_TOOLCHAIN=mingw \
