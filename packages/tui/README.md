...
```typescript
import { type TUI, Text, Editor, ProcessTerminal, TuiMainScreen, matchesKey } from "@ao-Barbosa/phi-tui";
...
```typescript
import { type TUI, TuiAltScreen, TuiMainScreen } from "@ao-Barbosa/phi-tui";
...
```typescript
import type { TuiMouseEvent, TuiMouseEventResult } from "@ao-Barbosa/phi-tui";
...
```typescript
import { CombinedAutocompleteProvider } from "@ao-Barbosa/phi-tui";
...
```typescript
import { visibleWidth, truncateToWidth, wrapTextWithAnsi } from "@ao-Barbosa/phi-tui";
...
```typescript
import { matchesKey, Key, truncateToWidth } from "@ao-Barbosa/phi-tui";
...
```bash
PHI_TUI_WRITE_LOG=/tmp/tui-ansi.log npx tsx test/chat-simple.ts
```
