...
function resolveExternalTarget(specifier: string, resolver?: FacetBundleExternalResolver): string {
	...
	if (specifier === "@ao-barbosa/phi-chord") return new URL(`../index.${extension}`, import.meta.url).href;
	if (specifier === "@ao-barbosa/phi-chord/context") {
		return new URL(`../context/index.${extension}`, import.meta.url).href;
	}
	if (specifier === "@ao-barbosa/phi-chord/node") return new URL(`../node.${extension}`, import.meta.url).href;
