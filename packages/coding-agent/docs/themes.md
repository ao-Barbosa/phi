...
- Packages: `themes/` directories or `phi.themes` entries in `package.json`
...
```json
{
  "$schema": "https://raw.githubusercontent.com/ao-Barbosa/phi/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
