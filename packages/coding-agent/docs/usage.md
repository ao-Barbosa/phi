...
If you use phi for open source work and want to publish sessions for model, prompt, tool, and evaluation research, see [`badlogic/phi-share-hf`](https://github.com/badlogic/phi-share-hf). It publishes sessions to Hugging Face datasets.
...
For the full rationale, read the [blog post](https://mariozechner.at/posts/2025-11-30-phi-coding-agent/).
