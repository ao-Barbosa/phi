...
- Packages: `skills/` directories or `phi.skills` entries in `package.json`
- Settings: `skills` array with files or directories
- CLI: `--skill <path>` (repeatable, additive even with `--no-skills`)

Discovery rules:
- In `~/.phi/agent/skills/` and `.phi/skills/`, direct root `.md` files are discovered as individual skills when they have valid skill frontmatter with a non-empty `description`
...
- [Phi Skills](https://github.com/badlogic/phi-skills) - Web search, browser automation, Google APIs, transcription
