import { defineFacet } from "@ao-barbosa/phi-chord";
import { AgentController, PresentationUI, SlashCommands } from "@ao-barbosa/phi-coding-agent/experimental/plugin";
import { ExampleFacetService } from "./contract.ts";

export default defineFacet({
	id: "@ao-barbosa/phi-example-plugin/tui",
	setup(env) {
