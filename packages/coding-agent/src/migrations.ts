...
const MIGRATION_GUIDE_URL =
	"https://github.com/ao-Barbosa/phi/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/ao-Barbosa/phi/blob/main/packages/coding-agent/docs/extensions.md";
 ...
 * Note: tools/ may contain fd/rg binaries extracted by phi, so only warn if it has other files.
 */
