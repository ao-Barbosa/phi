...
import { DEFAULT_RADIUS_GATEWAY, normalizeRadiusGatewayUrl } from "@ao-barbosa/phi-ai/providers/radius-config";
...
export const ENV_RADIUS_GATEWAY = "PHI_RADIUS_GATEWAY";
...
export class RadiusRelayAuthResolver {
	...
	async resolve(options: {
		...
		if (process.env.PHI_OFFLINE !== undefined) {
