import { type Context, defineService, type JsonValue } from "@ao-barbosa/phi-chord";
...
export const PresentationPlugins = defineService<PresentationPlugins>("phi.presentation-plugins");
...
export const SessionPlugins = defineService<SessionPlugins>("phi.session-plugins");
