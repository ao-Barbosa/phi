import { type Context, defineService } from "@ao-barbosa/phi-chord";
...
export const PresentationUI = defineService<PresentationUI>("phi.local.presentation-ui", { local: true });
