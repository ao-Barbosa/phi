...
import { Client, ServerError } from "@ao-barbosa/phi-client";
import { createUnixTransportFactory, discoverUnixServers, type UnixServerRoute } from "@ao-barbosa/phi-client/unix";
...
export interface OpenClientRuntimeOptions {
	/** Directory searched when --connect is omitted. Defaults to PHI_SERVER_DIR or ~/.pi/server. */
