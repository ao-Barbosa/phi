 ...
 *
 * Existing apps switch imports from "@ao-barbosa/phi-ai" to
 * "@ao-barbosa/phi-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@ao-barbosa/phi-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@ao-barbosa/phi-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@ao-barbosa/phi-ai/providers/all" or `Models.getProviders()`. */
