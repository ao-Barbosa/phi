...
export interface BedrockOptions extends StreamOptions {
	 ...
	 * @see https://docs.aws.amazon.com/bedrock/latest/APIReference/APHI_runtime_ConverseStream.html */
...
function addCustomHeadersMiddleware(client: BedrockRuntimeClient, headers: Record<string, string>): void {
	...
	client.middlewareStack.add(middleware, { step: "build", name: "phi-ai-custom-headers", priority: "low" });
}
...
function addResponseHeadersMiddleware(
	...
	client.middlewareStack.add(middleware, { step: "deserialize", name: "phi-ai-response-headers" });
}
 ...
 * Defaults to "short" and uses PHI_CACHE_RETENTION for backward compatibility.
 */
