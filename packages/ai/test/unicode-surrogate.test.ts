...
describe("AI Providers Unicode Surrogate Pair Tests", () => {
	describe.skipIf(!process.env.GEMINI_APHI_KEY)("Google Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.OPENAI_APHI_KEY)("OpenAI Completions Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.OPENAI_APHI_KEY)("OpenAI Responses Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.ANTHROPIC_APHI_KEY)("Anthropic Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.XAI_APHI_KEY)("xAI Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.GROQ_APHI_KEY)("Groq Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.CEREBRAS_APHI_KEY)("Cerebras Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.TOGETHER_APHI_KEY)("Together AI Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.BASETEN_APHI_KEY)("Baseten Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.ZAI_APHI_KEY)("zAI Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.MISTRAL_APHI_KEY)("Mistral Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.MINIMAX_APHI_KEY)("MiniMax Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.XIAOMI_APHI_KEY)("Xiaomi MiMo (API billing) Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.QWEN_TOKEN_PLAN_APHI_KEY)("Qwen Token Plan Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.QWEN_TOKEN_PLAN_APHI_KEY)(
		"Qwen Token Plan Individual Provider Unicode Handling",
		() => {
	...
	describe.skipIf(!process.env.QWEN_TOKEN_PLAN_CN_APHI_KEY)("Qwen Token Plan (CN) Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.KIMI_APHI_KEY)("Kimi For Coding Provider Unicode Handling", () => {
	...
	describe.skipIf(!process.env.AI_GATEWAY_APHI_KEY)("Vercel AI Gateway Provider Unicode Handling", () => {
