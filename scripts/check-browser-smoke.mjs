...
const outputPath = join(tmpdir(), "phi-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "phi-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "phi-browser-smoke-errors.log");
