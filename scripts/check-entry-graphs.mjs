...
const WORKSPACE = {
	"@ao-barbosa/phi-chord": "packages/chord/src",
	"@ao-barbosa/phi-ai": "packages/ai/src",
	"@ao-barbosa/phi-agent-core": "packages/agent/src",
	"@ao-barbosa/phi-telemetry": "packages/telemetry/src",
	"@ao-barbosa/phi-tui": "packages/tui/src",
};
