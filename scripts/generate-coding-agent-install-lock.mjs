...
const internalPackagePrefix = "@ao-barbosa/phi-";
const internalPackageNames = new Set(["@ao-barbosa/phi-chord"]);
const installPackageName = "@ao-barbosa/phi-coding-agent-install";
