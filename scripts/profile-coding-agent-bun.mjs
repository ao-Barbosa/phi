...
const agentDirEnvName = "PHI_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "PHI_STARTUP_BENCHMARK";
...
Options:
  ...
  --agent-dir <dir>      Use a specific PHI_CODING_AGENT_DIR for the benchmark run
  ...
  --no-offline           Do not force PHI_OFFLINE=1 / PHI_SKIP_VERSION_CHECK=1
...
function createBenchmarkEnv(options, isolatedAgentDir) {
	const env = { ...process.env, PHI_TIMING: "1" };
	if (options.agentDir) {
